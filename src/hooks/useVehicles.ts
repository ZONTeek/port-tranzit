...
export const useVehicles = () => {
    ...
    const vehicles = useQuery({queryKey: [VEHICLES_QUERY_KEY, filters], queryFn: async () => {
    ...
    const getVehicleInfo = (id: string) => useQuery({queryKey: [VEHICLE_QUERY_KEY, id], queryFn: async () => {
